...
################################################################################
# Script de Validação - Fluxo de Envio de Mídia Telegram
# Chat4All v2 - Unified Messaging Platform
#
# Descrição:
#   Testa o fluxo completo de upload de arquivo e envio de mensagem com anexo
#   via Telegram, validando integração entre File Service e Message Service.
#
# Fluxo:
...
echo "=========================================="
echo "  Chat4All v2 - Telegram File Flow Test"
echo "=========================================="
echo ""
...
MESSAGE_PAYLOAD=$(cat <<EOF
{
  ...
  "senderId": "@erik_dev",
  "content": "Documento enviado via Bot Telegram",
  "channel": "TELEGRAM",
  "fileIds": ["${FILE_ID}"]
}
EOF
...
echo ""
echo -e "${YELLOW}[4] Verificar logs do Telegram Connector:${NC}"
echo "    docker logs telegram-connector -f --tail=50"
echo "    Porta do serviço: 8092"
echo ""
